<nav x-data="{ open: false }" class="border-b bg-indigo-900">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('home') }}">
                        <img src="{{ asset('image/logo-blanco.webp') }}" alt="Logo" class="h-20 w-25">
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                <div class="ml-3 relative">
                    ...
                    @else
                        <div>
                            <a href="{{ route('login') }}" class="text-sm text-gray-500 mr-2">Entrar</a>

                            <a href="{{ route('register') }}"
                                class="bg-blue-500 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded">Registrarse</a>
                            {{-- <x-jet-secondary-button>Registrarse</x-jet-secondary-button> --}}
                        </div>
                    @endif
                </div>
            </div>
