                ...
                <div class="xl:ml-20 xl:w-5/12 lg:w-5/12 md:w-8/12 mb-20 md:mb-0">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="flex flex-row items-center justify-center lg:justify-start">
                            <p class="text-lg mb-0 mr-4">Inicia sesión con</p>
                        ...
                        <div class="mb-6">
                            ...
                            <input id="email" class="form-control block w-full px-4 py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                        ...
                        <div class="text-center lg:text-left">
                            ...
                            <p class="text-sm font-semibold mt-2 pt-1 mb-0">
                                ...
                                <a href="{{ route('password.request') }}"
                                    class="text-red-600 hover:text-red-700 focus:text-red-700 transition duration-200 ease-in-out">Regístrate</a>
                            </p>
                            @endif
                        </div>
                    </form>
