                                ...
                                <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                    ...
                                    <td class="py-4 px-6">
                                            <x-jet-dropdown align="right" width="48">
                                                ...
                                                <x-slot name="content">
                                                        <x-jet-dropdown-link class="text-left" wire:click="setPending({{$order->id}})">
                                                            Pendiente
                                                        </x-jet-dropdown-link>
                                                        <x-jet-dropdown-link class="text-left" wire:click="setApproved({{$order->id}})">
                                                            Aprovada
                                                        </x-jet-dropdown-link>
                                                        <x-jet-dropdown-link class="text-left" wire:click="setCompleted({{$order->id}})">
                                                            Completado
                                                        </x-jet-dropdown-link>
                                                        <x-jet-dropdown-link class="text-left" wire:click="setCanceled({{$order->id}})">
                                                            Cancelar
                                                        </x-jet-dropdown-link>
