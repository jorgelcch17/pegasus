        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 ">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 mt-2 gap-2">
                <a class="max-w-sm bg-white border border-gray-100 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700"
                    ...
                    <img class="w-full aspect-square" src="{{ asset('image/free-fire-index.jpg') }}" alt="freefire">
                    <span class="block font-bold text-center pt-2 text-black">Garena Free Fire Diamantes</span>
                </a>
                <a class="max-w-sm bg-white border border-gray-100 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700"
                    href="{{ route('mobile-legend.index') }}">
                    <img class="w-full aspect-square" src="{{ asset('image/mobile_legend.png') }}" alt="mobile legend">
                    <span class="block font-bold text-center pt-2 text-black">Mobile Legend</span>
                </a>

                <a class="max-w-sm bg-white border border-gray-100 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700"
                    href="{{route('mobile-legend.index') }}">
                    <img class="w-full aspect-square" src="{{ asset('image/pugb-mobile-index.jpg') }}" alt="mobile legend">
